...
public class Main extends Application {
    ...
    public void start(Stage window) throws Exception {
        ...
        if (getBackgroundService().stream().findAny().isPresent()) {;
            System.out.println("Background service started");
            BackgroundSPI backgroundService = getBackgroundService().stream().findAny().get();
            gameWindow.getChildren().add(backgroundService.getBackground(gameData));
        }
    ...
    private Collection<? extends BackgroundSPI> getBackgroundService() {
